...
ConfigSubstitutions ConfigBase::load_from_gcode_file(const std::string &file, ForwardCompatibilitySubstitutionRule compatibility_rule, const std::string& strGeneratorKeyword )
{
    ...
    bool has_delimiters = true;
    {
        ...
        bool bUseSpecificGenerator = strGeneratorKeyword != "";
        orcaslicer_gcode_header += strGeneratorKeyword != "" ? strGeneratorKeyword : SLIC3R_APP_NAME;
