...
// Step 3.4: OPTION_TO_STORE_ISLAND is a PrusaSlicer developer debug facility.
// Disabled here because PhrozenOrca's SVG class does not implement draw_original().
