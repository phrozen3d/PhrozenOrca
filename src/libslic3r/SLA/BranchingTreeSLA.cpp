...
///|/
// Step 3.3: Ported from PrusaSlicer's SLA/BranchingTreeSLA.cpp.
// Adaptations for PhrozenOrca:
//   - SupportTreeUtils.hpp is the PhrozenOrca port (IndexedMesh-based)
//   - execution:: namespace available via ExecutionTBB.hpp
//   - m_gnd_connections_mtx: execution::SpinningMutex<ExecutionTBB> available
//   - All other code identical to PrusaSlicer
