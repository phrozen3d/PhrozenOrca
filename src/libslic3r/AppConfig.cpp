...
static const std::string VERSION_CHECK_URL_STABLE = "https://api.github.com/repos/MaxShih147/OrcaSlicer/releases/latest";
static const std::string VERSION_CHECK_URL = "https://api.github.com/repos/MaxShih147/OrcaSlicer/releases";
