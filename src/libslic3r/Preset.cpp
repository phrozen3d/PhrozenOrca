...
#pragma region Phrozen LCD Parameter
    "bottom_layer_count", "exposure_time", "bottom_exposure_time",
    "transition_layer_count", "transition_type", "transition_layer_interval_time_difference",
    "waiting_mode_during_printing",
    "rest_time_before_lift", "rest_time_after_lift", "rest_time_after_retract",
    "light_off_day", "bottom_light_off_day",
    "bottom_lift_distance", "lifting_distance", "bottom_retract_distance", "retract_distance",
    "bottom_lift_speed", "lifting_speed", "bottom_retract_speed", "retract_speed",
    ...
    "shrinkage_compensation_x",
    "shrinkage_compensation_y",
    "shrinkage_compensation_z",
    "tolerance_compensation",
    "tolerance_compensation_a",
    "tolerance_compensation_b",
    "bottom_tolerance_compensation",
    "bottom_tolerance_compensation_a",
    "bottom_tolerance_compensation_b",
    "generate_support",
    "top_upper_diameter", "top_contact_depth", "pinhead_width",
    "pillar_diameter", "angle_between_top_and_middle",
    "support_bottom_diameter", "support_boss_height",
    "object_elevation",
    "support_points_density", /*"max_bridge_length",*/ "max_pillar_linking_distance",
#pragma endregion
    "initial_layer_print_height", "wall_loops", "alternate_extra_wall", "slice_closing_radius", "spiral_mode", "spiral_mode_smooth", "spiral_mode_max_xy_smoothing", "spiral_starting_flow_ratio", "spiral_finishing_flow_ratio", "slicing_mode",
