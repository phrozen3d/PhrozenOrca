#ifndef slic3r_PhrozenLCDTab_hpp_
#define slic3r_PhrozenLCDTab_hpp_
...
class PhrozenLCDTabPrint : public Tab
{
public:
	//BBS: GUI refactor
	PhrozenLCDTabPrint(ParamsPanel* parent, Preset::Type type = Preset::TYPE_PRINT) :
...
class PhrozenLCDTabPrintModel : public PhrozenLCDTabPrint
{
public:
	//BBS: GUI refactor
	PhrozenLCDTabPrintModel(ParamsPanel* parent, std::vector<std::string> const & keys);
	~PhrozenLCDTabPrintModel() {}
...
class PhrozenLCDTabPrintPlate : public PhrozenLCDTabPrintModel
{
public:
	//BBS: GUI refactor
	PhrozenLCDTabPrintPlate(ParamsPanel* parent);
	~PhrozenLCDTabPrintPlate() {}
	void build() override;
...
class PhrozenLCDTabPrintObject : public PhrozenLCDTabPrintModel
{
public:
	//BBS: GUI refactor
	PhrozenLCDTabPrintObject(ParamsPanel* parent);
	~PhrozenLCDTabPrintObject() {}
protected:
	virtual void    notify_changed(ObjectBase * object) override;
};

class PhrozenLCDTabPrintPart : public PhrozenLCDTabPrintModel
{
public:
	//BBS: GUI refactor
	PhrozenLCDTabPrintPart(ParamsPanel* parent);
	~PhrozenLCDTabPrintPart() {}
protected:
	virtual void    notify_changed(ObjectBase * object) override;
};

class PhrozenLCDTabPrintLayer : public PhrozenLCDTabPrintModel
{
public:
	//BBS: GUI refactor
	PhrozenLCDTabPrintLayer(ParamsPanel* parent);
	~PhrozenLCDTabPrintLayer() {}
protected:
	virtual void    notify_changed(ObjectBase* object) override;
	virtual void    update_custom_dirty() override;
};

class PhrozenLCDTabFilament : public Tab
{
private:
...
public:
	//BBS: GUI refactor
	PhrozenLCDTabFilament(ParamsPanel* parent) :
		Tab(parent, _(L("Filament")), Slic3r::Preset::TYPE_FILAMENT) {}
	~PhrozenLCDTabFilament() {}
...
class PhrozenLCDTabPrinter : public Tab
{
private:
...
public:
	...
	//BBS: GUI refactor
    PhrozenLCDTabPrinter(ParamsPanel* parent) :
        Tab(parent, _L("Machine"), Slic3r::Preset::TYPE_PRINTER) {}
	~PhrozenLCDTabPrinter() {}
...
class PhrozenLCDTabSLAMaterial : public Tab
{
public:
	//BBS: GUI refactor
    PhrozenLCDTabSLAMaterial(ParamsPanel* parent) :
		Tab(parent, _(_devL("Material Settings")), Slic3r::Preset::TYPE_SLA_MATERIAL) {}
    ~PhrozenLCDTabSLAMaterial() {}
...
class PhrozenLCDTabSLAPrint : public Tab
{
public:
	//BBS: GUI refactor
    PhrozenLCDTabSLAPrint(ParamsPanel* parent) :
        Tab(parent, _(L("Process Settings")), Slic3r::Preset::TYPE_SLA_PRINT) {}
    ~PhrozenLCDTabSLAPrint() {}
...
#endif /* slic3r_PhrozenLCDTab_hpp_ */
