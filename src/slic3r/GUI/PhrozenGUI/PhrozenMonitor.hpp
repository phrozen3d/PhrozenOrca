#ifndef slic3r_PhrozenMonitor_hpp_
#define slic3r_PhrozenMonitor_hpp_
...
public:
    PhrozenMonitorPanel(wxWindow*      parent,
    ...
    PhrozenStatusPanel* get_status_panel() { return m_status_info_panel; };
