#ifndef slic3r_GUI_PHROZENSIDETOOLS_hpp_
#define slic3r_GUI_PHROZENSIDETOOLS_hpp_
...
#define PHROZEN_SIDE_TOOLS_GREY900 wxColour(38, 46, 48)
#define PHROZEN_SIDE_TOOLS_GREY600 wxColour(144, 144, 144)
#define PHROZEN_SIDE_TOOLS_GREY400 wxColour(206, 206, 206)
#define PHROZEN_SIDE_TOOLS_BRAND wxColour(255, 124, 63)
#define PHROZEN_SIDE_TOOLS_LIGHT_GREEN wxColour(219, 253, 231)

#define PHROZEN_SIDE_TOOL_CLICK_INTERVAL 20

namespace Slic3r { namespace GUI {

class PhrozenSideToolsPanel : public wxPanel
{
private:
...
public:
    PhrozenSideToolsPanel(wxWindow *parent, wxWindowID id = wxID_ANY, const wxPoint &pos = wxDefaultPosition, const wxSize &size = wxDefaultSize);
    ~PhrozenSideToolsPanel();
...
class PhrozenSideTools : public wxPanel
{
public:
    PhrozenSideTools(wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize);
    ~PhrozenSideTools();

private:
    PhrozenSideToolsPanel* m_side_tools{ nullptr };
...
public:
    PhrozenSideToolsPanel* get_panel() {return m_side_tools;};
};
}} // namespace Slic3r::GUI

#endif // !slic3r_GUI_PHROZENSIDETOOLS_hpp_
