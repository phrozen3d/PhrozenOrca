...
void GLGizmoSimplify::on_render_input_window(float x, float y, float bottom_limit)
{
    ...
    ImGui::PushStyleColor(ImGuiCol_Text, ImGuiWrapper::COL_PHROZEN); // ORCA Use orca color for step slider text
    ImGui::PushStyleColor(ImGuiCol_SliderGrab, ImGuiWrapper::COL_PHROZEN); // ORCA Use orca color for step slider thumb
