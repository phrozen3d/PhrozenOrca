...
{
    // Hide SideButtons that were created but not appended (e.g. conditional menu items).
    // Without this, orphan controls paint at the default position and overlap the first row.
