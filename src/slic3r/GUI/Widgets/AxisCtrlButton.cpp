...
PhrozenAxisCtrlButton::PhrozenAxisCtrlButton(wxWindow *parent, ScalableBitmap &icon, long stlye)
    : AxisCtrlButton( parent, icon, stlye )
{
	wxWindow::SetBackgroundColour(parent->GetBackgroundColour());

    border_color.clear();
    border_color.append(phrozen_bd, StateColor::Hovered);

    background_color.clear();
    background_color.append(PHROZEN_BUTTON_BG_COL, StateColor::Disabled);
    background_color.append(PHROZEN_BUTTON_PRESS_COL, StateColor::Pressed);
    background_color.append(PHROZEN_BUTTON_BG_COL, StateColor::Hovered);
    background_color.append(PHROZEN_BUTTON_BG_COL, StateColor::Normal);
    background_color.append(PHROZEN_BUTTON_BG_COL, StateColor::Enabled);

    inner_background_color.clear();
    inner_background_color.append(PHROZEN_BUTTON_IN_BG_COL, StateColor::Disabled);
    inner_background_color.append(PHROZEN_BUTTON_PRESS_COL, StateColor::Pressed);
    inner_background_color.append(PHROZEN_BUTTON_IN_BG_COL, StateColor::Hovered);
    inner_background_color.append(PHROZEN_BUTTON_IN_BG_COL, StateColor::Normal);
    inner_background_color.append(PHROZEN_BUTTON_IN_BG_COL, StateColor::Enabled);
...
void PhrozenAxisCtrlButton::render(wxDC& dc) 
{
    ...
    outer_path.AddCircle(0, 0, r_outer);
    outer_path.AddCircle(0, 0, r_inner);
    gc->SetPen(StateColor::darkModeColorFor(PHROZEN_BUTTON_BG_COL));
    gc->SetBrush(StateColor::darkModeColorFor(PHROZEN_BUTTON_BG_COL));
    gc->DrawPath(outer_path);
    ...
    inner_path.AddCircle(0, 0, r_inner);
    inner_path.AddCircle(0, 0, r_blank);
    gc->SetPen(StateColor::darkModeColorFor(PHROZEN_BUTTON_IN_BG_COL));
    gc->SetBrush(StateColor::darkModeColorFor(PHROZEN_BUTTON_IN_BG_COL));
	gc->DrawPath(inner_path);
