    ...
    , state_handler(this)
{
    ...
    border_color.append(0xDD5013, StateColor::Pressed);
    border_color.append(0xF05E20, StateColor::Hovered);
    ...
    background_color.append(0xDD5013, StateColor::Pressed);
    background_color.append(0xF05E20, StateColor::Hovered);
    background_color.append(0xFF7C3F, StateColor::Normal);
