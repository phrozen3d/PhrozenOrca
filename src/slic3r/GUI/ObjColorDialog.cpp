...
{
    auto       btn_sizer = new wxBoxSizer(wxHORIZONTAL);
    StateColor calc_btn_bg(std::pair<wxColour, int>(wxColour(0, 137, 123), StateColor::Pressed), std::pair<wxColour, int>(wxColour(240, 94, 32), StateColor::Hovered),
                           std::pair<wxColour, int>(wxColour(255, 124, 63), StateColor::Normal));
    StateColor calc_btn_bd(std::pair<wxColour, int>(wxColour(255, 124, 63), StateColor::Normal));
