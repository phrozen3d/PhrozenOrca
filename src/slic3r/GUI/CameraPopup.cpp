   ...
   : PopupWindow(parent, wxBORDER_NONE | wxPU_CONTAINS_CONTROLS)
{
    ...
    m_custom_camera_input_confirm->SetBackgroundColor(wxColour(240, 94, 32));
    m_custom_camera_input_confirm->SetBorderColor(wxColour(240, 94, 32));
...
void CameraPopup::set_custom_cam_button_state(bool state)
{
    ...
    auto stateColour = state ? wxColour(170, 0, 0) : wxColour(240, 94, 32);
