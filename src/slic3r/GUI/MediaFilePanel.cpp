    ...
    , m_machine("<null>")
{
    ...
    m_button_management->SetBackgroundColorNormal(wxColor("#FF7C3F"));
    m_button_management->SetTextColorNormal(*wxWHITE);
    m_button_management->Enable(false);
    m_button_refresh->SetBorderWidth(0);
    m_button_refresh->SetBackgroundColorNormal(wxColor("#FF7C3F"));
            ...
            if (index != -1) {
                ...
                fs->FetchModel(index, [this, fs, dlg, index](int result, std::string const &data) {
                    ...
                    if (gcode_file_count > 0) {
                        ...
                        MessageDialog dlg(this, _L("The .gcode.3mf file contains no G-code data. Please slice it with Phrozen Orca and export a new .gcode.3mf file."),
