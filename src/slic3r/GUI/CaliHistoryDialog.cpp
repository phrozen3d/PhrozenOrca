    ...
    , m_show_history_dialog(show)
{
    ...
    mew_btn->SetBorderColor(wxColour(255, 124, 63));
...
void HistoryWindow::sync_history_data() {
    ...
    for (auto& result : m_calib_results_history) {
        ...
        edit_button->SetBorderColor(wxColour(255, 124, 63));
    ...
    , m_new_result(result)
{
    ...
    save_btn->SetBorderColor(wxColour(255, 124, 63));
    ...
    , m_history_results(history_results)
{
    ...
    ok_btn->SetBorderColor(wxColour(255, 124, 63));
