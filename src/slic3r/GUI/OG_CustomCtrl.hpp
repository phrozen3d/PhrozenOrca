...
class OG_CustomCtrl :public wxPanel
{
    ...
    struct CtrlLine {
        ...
        wxCoord draw_text      (wxDC& dc, wxPoint pos, const wxString& text, const wxColour* color, int width, bool is_url = false, bool is_main = false, bool label_align_top = false);
