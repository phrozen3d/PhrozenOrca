...
static const ImU32 BRAND_COLOR            = IM_COL32(255, 124, 63, 255);
...
bool IMSlider::render(int canvas_width, int canvas_height)
{
    ...
    ImGui::PushStyleColor(ImGuiCol_::ImGuiCol_Text, ImGuiWrapper::COL_PHROZEN); // ORCA: Use orca color for slider value text
