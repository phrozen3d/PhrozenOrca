...
void MsgDialog::apply_style(long style)
{
    ...
    logo->SetBitmap( create_scaled_bitmap(style & wxAPPLY        ? "completed" :
                                          ...
                                          style & wxICON_QUESTION       ? "question"    : "PhrozenOrca_Notification", this, 64, style & wxICON_ERROR));
}
	...
	, msg(msg)
{
	...
	logo->SetBitmap(create_scaled_bitmap("PhrozenOrca_192px_grayscale.png", this, monospaced_font ? 48 : /*1*/84));
...
wxBoxSizer *Newer3mfVersionDialog::get_msg_sizer()
{
    ...
    if (file_version_newer) { 
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3mf file version is in Beta and it is newer than the current PhrozenOrca version."));
        wxStaticText *   text2       = new wxStaticText(this, wxID_ANY, _L("If you would like to try Phrozen Orca Beta, you may click to"));
        ...
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3mf file version is newer than the current Phrozen Orca version."));
        wxStaticText *text2 = new wxStaticText(this, wxID_ANY, _L("Update your Phrozen Orca could enable all functionality in the 3mf file."));
        horizontal_sizer->Add(text2, 0, wxEXPAND, 0);
    }
