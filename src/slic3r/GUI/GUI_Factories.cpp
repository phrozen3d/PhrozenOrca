...
std::map<std::string, std::vector<SimpleSettingData>>  SettingsFactory::PART_CATEGORY_SETTINGS=
{
    ...
    { L("Speed"), {{"outer_wall_speed", "",1},{"inner_wall_speed", "",2},{"sparse_infill_speed", "",3},{"top_surface_speed", "",4}, {"internal_solid_infill_speed", "",5},
                    {"enable_overhang_speed", "",6}, {"overhang_0_4_speed", "",7}, {"overhang_1_4_speed", "",8}, {"overhang_2_4_speed", "",9}, {"overhang_3_4_speed", "",10}, {"overhang_4_4_speed", "",11},
                    {"bridge_speed", "",12}, {"gap_infill_speed", "",13}, {"internal_bridge_speed", "", 14}
                    }}
};
    ...
    for (auto &item : {L("3DBenchy"), L("Autodesk FDM Test"), L("Voron Cube"), L("Stanford Bunny") }) {
        append_menu_item(
            ...
            [type, item](wxCommandEvent&) {
                ...
                else if (file_name == L("PhrozenOrca String Hell")) {
