...
static const wxColour TEXT_NORMAL_CLR = wxColour(255, 124, 63);
    ...
    :wxPanel(parent, id, pos, size, style)
{
    ...
    StateColor btn_bg(std::pair<wxColour, int>(wxColour(255, 255, 255), StateColor::Disabled), std::pair<wxColour, int>(wxColour(0, 137, 123), StateColor::Pressed),
                      std::pair<wxColour, int>(wxColour(240, 94, 32), StateColor::Hovered), std::pair<wxColour, int>(wxColour(255, 124, 63), StateColor::Enabled),
                      std::pair<wxColour, int>(wxColour(255, 124, 63), StateColor::Normal));
    StateColor btn_bd(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(255, 124, 63), StateColor::Enabled));
