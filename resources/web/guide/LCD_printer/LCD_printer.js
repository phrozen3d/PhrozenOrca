...
'</div>';
		...
		ModelHtml[strVendor]+='<div class="PrinterBlock" data-model="'+OneModel['model']+'" data-vendor="'+strVendor+'" data-nozzle="'+nozzleVal+'">'+
		'	<div class="PImg"><img src="'+CoverImage+'"  /></div>'+
		'    <div class="PName">'+OneModel['name']+'</div></div>';
